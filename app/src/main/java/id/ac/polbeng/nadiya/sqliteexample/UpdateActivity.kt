...
import id.ac.polbeng.nadiya.sqliteexample.databinding.ActivityUpdateBinding
...
class UpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnUpdate.setOnClickListener {
            ...
            if (updateCount > 0) {
                Toast.makeText(this, "Data mahasiswa yang terupdate: $updateCount", Toast.LENGTH_SHORT).show()
                finish()
            } else {
        ...
        binding.btnHapus.setOnClickListener {
            ...
            builder.setTitle("Konfirmasi Hapus Data")
                ...
                .setPositiveButton("Ya") { _, _ ->
                    ...
                    if (deleteCount > 0) {
                        Toast.makeText(this, "Data mahasiswa yang terhapus: $deleteCount", Toast.LENGTH_SHORT).show()
                        finish()
                    } else {
                ...
                .setNegativeButton("Tidak") { _, _ ->
                    // Dialog dibatalkan oleh pengguna
                }
